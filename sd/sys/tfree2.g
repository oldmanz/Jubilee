; tfree2.g
; Runs at the start of a toolchange if the current tool is tool-2.
...
G53 G0 X{global.parkX2} Y{global.safeYTool} F12000       ; Rapid to the back of the post. Stay away from the tool rack so we don't collide with tools.
...
G53 G1 Y{global.parkY2} F6000            ; Controlled move to the park position with tool-1. (park_x, park_y)
